...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "Basic data handling: DictGetKeysValues": "get_keys_values",
    "Basic data handling: DictRemove": "remove",
    "Basic data handling: DictFilterByKeys": "filter_by_keys",
    "Basic data handling: DictExcludeKeys": "exclude_keys",
    "Basic data handling: DictGetMultiple": "get_multiple",
